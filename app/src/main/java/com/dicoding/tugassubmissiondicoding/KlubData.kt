...
object KlubData {
    private val klubNames = arrayOf("Arsenal FC",
        "FC Bayern Munchen",
        "Chelsea FC",
        "FC Barcelona",
        "Juventus FC",
    ...
    private val klubImages = intArrayOf(R.drawable.arsenal,
    ...
    private val klubDetails = arrayOf(
        arrayOf(
            "Arsenal FC",
    ...
    val listData: ArrayList<Klub>
        get(){
            ...
            for (position in klubNames.indices){
                val klub = Klub()
                klub.name = klubNames[position]
                klub.photo = klubImages[position]
                klub.detail = klubDetails[position].toString()
                list.add(klub)
            }
            return list
        }
